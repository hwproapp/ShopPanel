...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("newsSite90tv.Models.EnableLevels", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("Tbl_EnableLevels");
                });

            modelBuilder.Entity("newsSite90tv.Models.enableLevelstate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("datemiladi");
                    ...
                    b.ToTable("Tbl_enableLevelstate");
                });
            ...
            modelBuilder.Entity("newsSite90tv.Models.payment", b =>
                {
                    ...
                    b.Property<DateTime>("updatedateml");

                    b.Property<string>("updatedatesh");
            ...
            modelBuilder.Entity("newsSite90tv.Models.SellerSell", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<byte>("fixstate");

                    b.Property<bool>("isenable");

                    b.Property<long>("orderdetail_id");

                    b.Property<byte>("sellstate");
            ...
            modelBuilder.Entity("newsSite90tv.Models.shopadvertise", b =>
                {
                    ...
                    b.Property<string>("userapptoken");
            ...
            modelBuilder.Entity("newsSite90tv.Models.UserApp", b =>
                {
                    ...
                    b.Property<bool>("emailactivestatus");
            ...
            modelBuilder.Entity("newsSite90tv.Models.UserBuy", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("newsSite90tv.Models.enableLevelstate", b =>
                {
                    b.HasOne("newsSite90tv.Models.EnableLevels", "Tbl_Level")
                        .WithMany()
            ...
            modelBuilder.Entity("newsSite90tv.Models.SellerSell", b =>
                {
                    ...
                    b.HasOne("newsSite90tv.Models.orderDetail", "Tbl_OrderDetail")
                        .WithMany()
